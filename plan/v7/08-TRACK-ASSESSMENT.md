...
| 2 | **Leverage native interleaved output for rich, mixed-media responses** | 음성(30 HD프리셋) + 이미지(Progressive) + BGM(프리셋) 실시간 스트림 | ⭐⭐⭐ |
...
| 프리셋 BGM 로딩 지연 | 🟢 10% | 하 | Cloud Storage CDN + 프리로드 |
...
- **Grand Prize**: $25,000 + Google Cloud 크레딧 + Google I/O 티켓 + 여행비 (총 ~$38,598 상당)

### 6.1.1 전체 상금 구조

| 상 | 수 | 상금 | 비고 |
|---|---|---|---|
| **Grand Prize** | 1팀 | $25,000 + 크레딧/티켓/여행비 (~$38,598) | Stage 3 최종 심사 |
| **Category Winner** | 트랙당 1팀 (3팀) | $10,000 각 | Creative Storyteller 포함 |
| **Subcategory Prize** | 3개 | $5,000 각 | Best Multimodal UX 등 |
| **Honorable Mentions** | 5팀 | $2,000 각 | 추가 인정 |

> **missless 최소 타겟**: Category Winner ($10,000) 또는 Subcategory ($5,000)
> **최대 타겟**: Grand Prize + Category Winner 동시 수상
...
>
> **V7 계획대로 실행하면 수상 가능성이 매우 높습니다.**

---

*본 문서는 2026-02-24 기준 DevPost 공식 규칙 및 V7 계획 전체를 분석하여 작성되었습니다.*
